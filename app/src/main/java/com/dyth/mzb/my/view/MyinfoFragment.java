...
import com.dyth.mzb.alladapter.InfoConmmentAdapter;
...
public class MyinfoFragment extends BaseFragment implements MyCOMContract.IMyCOMView {
    ...
    private InfoConmmentAdapter infoConmmentAdapter;
    ...
    protected View getonCreateView() {
        ...
        infoConmmentAdapter = new InfoConmmentAdapter(userCommentListBeans, getContext());
        my_rlv.setAdapter(infoConmmentAdapter);
        return inflate;
    }
    ...
    public void getData(Object o) {
        ...
        if(myCOM.getMessage().equals("成功")){
            ...
            infoConmmentAdapter.notifyDataSetChanged();
        }
