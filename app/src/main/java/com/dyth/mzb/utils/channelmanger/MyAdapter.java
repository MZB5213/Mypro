...
import static com.dyth.mzb.utils.channelmanger.DataUtils.leftStepList;
import static com.dyth.mzb.utils.channelmanger.DataUtils.rightStepList;
...
public class MyAdapter extends RecyclerView.Adapter<MyViewHolder> implements TouchInterface {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyViewHolder viewHolder = new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.grid_item, parent, false));
        return viewHolder;
    }
