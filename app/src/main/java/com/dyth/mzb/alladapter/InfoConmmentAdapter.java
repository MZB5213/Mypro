...
public class InfoConmmentAdapter extends RecyclerView.Adapter {

    private List<MyCOM.DataBean.UserCommentListBean> userCommentListBeans;
    private Context context;

    public InfoConmmentAdapter(List<MyCOM.DataBean.UserCommentListBean> userCommentListBeans, Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if(userCommentListBeans.get(position).getObjectType().equals("0")){
